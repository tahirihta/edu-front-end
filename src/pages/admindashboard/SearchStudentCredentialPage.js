...
class SearchStudentCredentialPage extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post("http://d24w27cd80vt93.cloudfront.net/api/digCred/search", data).then(res => {
                if(res.data.length > 0) {
                    toastr.success("Found student credential with this information!");
                } else {
                    toastr.error("No student credential found with this information!");
                }
            })
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="position-relative form-group">
                                                    ...
                                                    <input name="programname" value={this.state.programname} onChange={this.onChange} placeholder="Program Name" type="text" className="form-control" />
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="position-relative form-group">
                                                    <label className="">University</label>
                                                    <input name="university" value={this.state.university} onChange={this.onChange} placeholder="University" type="text" className="form-control" />
                                                </div>
                                            </div>
                                        </div>
