...
class CreateCredentialPage extends Component {
    ...
    onSubmit = e => {
        ...
        if (
            ...
            this.state.attributionDate &&
            this.state.programName &&
            this.state.type_digital_credential
        ) {
            Axios.post(
                "http://d24w27cd80vt93.cloudfront.net/api/digCred/issue",
                {
                ...
                .catch(err =>
                    toastr.success("Someting wrong! Please check your inputs.")
                );
        } else {
                    ...
                    <div className="app-page-title">
                        <div className="page-title-wrapper">
                            <div className="page-title-heading">
                                ...
                                <div>Add New Digital Credential</div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
